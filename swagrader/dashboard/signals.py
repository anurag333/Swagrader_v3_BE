...
def create_question_default_global_rubric(sender, instance, created, **kwargs):
    if created:
        GlobalRubric.objects.create(
            question=instance, description='Correct', marks=instance.max_marks)
        GlobalRubric.objects.create(
            question=instance, description='Incorrect', marks=instance.min_marks)
...
def create_subquestion_default_global_rubric(sender, instance, created, **kwargs):
    if created:
        GlobalSubrubric.objects.create(
            sub_question=instance, description='Correct', marks=instance.max_marks)
        GlobalSubrubric.objects.create(
            sub_question=instance, description='Incorrect', marks=instance.min_marks)
